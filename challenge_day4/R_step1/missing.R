...
file.exists("challenge_day4/testdata/data1.json")
json_data <- fromJSON(readLines("challenge_day4/fulldata/data1.json"))
...
write(json_text, "challenge_day4/testdata/data2.json")
